...
public enum TileType {
	 ...
	 * Piece TypeI.
	 */
	TypeI(new Color(129, 231, 231), 4, 4, 1, new boolean[][] {
		{
	 ...
	 * Piece TypeJ.
	 */
	TypeJ(new Color(121, 121, 231), 3, 3, 2, new boolean[][] {
		{
			true,	false,	false,
			true,	true,	true,
			false,	false,	false,
	 ...
	 * Piece TypeL.
	 */
	TypeL(new Color(229, 169, 109), 3, 3, 2, new boolean[][] {
		{
			false,	false,	true,
			true,	true,	true,
			false,	false,	false,
	 ...
	 * Piece TypeO.
	 */
	TypeO(new Color(222, 222, 112), 2, 2, 2, new boolean[][] {
		{
			true,	true,
			true,	true,
		},
	 ...
	 * Piece TypeS.
	 */
	TypeS(new Color(128, 217, 128), 3, 3, 2, new boolean[][] {
		{
			false,	true,	true,
			true,	true,	false,
			false,	false,	false,
	 ...
	 * Piece TypeT.
	 */
	TypeT(new Color(211, 104, 211), 3, 3, 2, new boolean[][] {
		{
			false,	true,	false,
			true,	true,	true,
			false,	false,	false,
	 ...
	 * Piece TypeZ.
	 */
	TypeZ(new Color(236, 106, 141), 3, 3, 2, new boolean[][] {
		{
			true,	true,	false,
			false,	true,	true,
			false,	false,	false,
